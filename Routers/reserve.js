...
router.get('/slipcheck/:photoname', async(req, res) => {
    const photoname = req.params.photoname;
    const photo_url = `${forword_url}/paymentImage/${photoname}`;
    const formData = new FormData();
    formData.append('url', photo_url);
    try{
        console.log(`${photo_url} : ` ,url, "+", key);
